...
var _setStatic = __webpack_require__(17);
...
var _Staw = __webpack_require__(5);

var _Staw2 = _interopRequireDefault(_Staw);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _Staw2.default;
...
var _Staw = __webpack_require__(6);

var _Staw2 = _interopRequireDefault(_Staw);

var _Swipper = __webpack_require__(15);
...
var getRollSlides = function getRollSlides(children, visibleGutter, itemWidth) {
...
var Staw = function Staw(_ref) {
	var children = _ref.children,
	    ...
	    _ref$visibleGutter = _ref.visibleGutter,
	    visibleGutter = _ref$visibleGutter === undefined ? 0 : _ref$visibleGutter,
...
exports.default = (0, _Staw2.default)(Staw);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_change_emitter__ = __webpack_require__(10);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_symbol_observable__ = __webpack_require__(11);
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(12), __webpack_require__(13)(module)))
...
var _withState = __webpack_require__(16);

var _withState2 = _interopRequireDefault(_withState);

var _withHandlers = __webpack_require__(19);
...
var enhance = (0, _compose2.default)((0, _withState2.default)('startReference', 'changeStartReference', null), (0, _withHandlers2.default)({
	onTouchStart: function onTouchStart(_ref) {
		var changeStartReference = _ref.changeStartReference;
		return function (ev) {
			changeStartReference(ev.touches[0].pageX);
		};
	},
	onTouchEnd: function onTouchEnd(_ref2) {
		var changeStartReference = _ref2.changeStartReference,
		    onSwipeLeftToRight = _ref2.onSwipeLeftToRight,
		    onSwipeRightToLeft = _ref2.onSwipeRightToLeft,
		    startReference = _ref2.startReference;
		return function (ev) {
			var pageX = ev.changedTouches[0].pageX;
			var diff = pageX - startReference;
			if (diff > 0 && diff - 50 > 0) {
...
var Swipper = function Swipper(_ref3) {
	var children = _ref3.children,
	    onTouchEnd = _ref3.onTouchEnd,
	    onTouchStart = _ref3.onTouchStart,
	    rest = _objectWithoutProperties(_ref3, ['children', 'onTouchEnd', 'onTouchStart']);
...
exports.default = enhance(Swipper);
...
var _setDisplayName = __webpack_require__(2);
